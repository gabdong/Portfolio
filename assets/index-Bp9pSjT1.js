 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var kd;function Oh(){if(kd)return li;kd=1;var i=mo(),o=Symbol.for("react.element"),u=Symbol.for("react.fragment"),d=Object.prototype.hasOwnProperty,f=i.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,p={key:!0,ref:!0,__self:!0,__source:!0};function g(v,y,k){var I,T={},C=null,L=null;k!==void 0&&(C=""+k),y.key!==void 0&&(C=""+y.key),y.ref!==void 0&&(L=y.ref);for(I in y)d.call(y,I)&&!p.hasOwnProperty(I)&&(T[I]=y[I]);if(v&&v.defaultProps)for(I in y=v.defaultProps,y)T[I]===void 0&&(T[I]=y[I]);return{$$typeof:o,type:v,key:C,ref:L,props:T,_owner:f.current}}return li.Fragment=u,li.jsx=g,li.jsxs=g,li}var jd;function Dh(){return jd||(jd=1,bs.exports=Oh()),bs.exports}var s=Dh(),_l={},Ks={exports:{}},at={},Gs={exports:{}},Xs={};/**
 * @license React
...
`,V0=ye.span`
  ...
  ${He.small`
    font-size: 42px;
  `}
`;function Q0({menuOn:i,setMenuOn:o,pathname:u}){const d=_.useRef(null);return _.useEffect(()=>{const f=d.current;let p=null;i&&(f.classList.add("on"),f.classList.remove("hide"),p&&clearTimeout(p)),i||(f.classList.contains("on")?(f.classList.remove("on"),p=setTimeout(()=>{f.classList.add("hide")},300)):(f.classList.remove("on"),f.classList.add("hide")))},[i]),s.jsxs(b0,{id:"menu",ref:d,children:[s.jsx("div",{className:"menuBackground"}),s.jsx(Zl,{style:{display:"flex",alignItems:"center",position:"relative"},children:s.jsx(Y0,{children:s.jsxs(K0,{id:"menuTextList",children:[s.jsx(Xd,{setMenuOn:o,path:"experience",text:"Experience",currentPath:u}),s.jsx(Xd,{setMenuOn:o,path:"contact",text:"Contact",currentPath:u})]})})})]})}const b0=ye.div`
  display: flex;
  width: 100%;
  height: 100%;
...
`;function G0(){const[i,o]=_.useState(!1),u=qt(),{pathname:d}=u;return s.jsxs(X0,{id:"nav",children:[s.jsx(O0,{menuOn:i,setMenuOn:o,pathname:d}),s.jsx(Q0,{menuOn:i,setMenuOn:o,pathname:d})]})}const X0=ye.nav`
  overflow: hidden;
